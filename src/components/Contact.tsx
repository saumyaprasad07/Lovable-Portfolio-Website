    ...
    <section id="contact" className="py-12 bg-gradient-to-b from-background to-muted/20">
      <div className="container mx-auto max-w-5xl px-4">
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          <div className="soft-card p-5 bg-gradient-to-br from-background to-muted/30">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <a
                    ...
                    className="text-foreground hover:text-primary transition-colors font-medium truncate block text-sm"
                  >
            ...
            <div className="border-t border-border pt-4">
              <p className="text-xs font-medium text-muted-foreground mb-2">Connect with me</p>
              <div className="flex flex-wrap gap-2">
                <a
                  href="https://www.linkedin.com/in/saumyaprasad07/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-3 py-2 rounded-lg border border-border hover:border-primary hover:bg-primary/5 transition-all group"
                >
