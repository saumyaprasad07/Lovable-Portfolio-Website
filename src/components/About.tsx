  ...
  return <section id="about" className="py-20 px-4">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="glass-card p-6 text-center animate-fade-in" style={{
          animationDelay: "0.1s"
        }}>
          ...
          animationDelay: "0.3s"
            ...
            <h3 className="text-2xl font-bold mb-2">M.S.</h3>
            <p className="text-muted-foreground">Information Systems</p>
          </div>
        </div>
      </div>
    </section>;
