...
const Projects = () => {
  ...
  return <section id="projects" className="section-spacing bg-background">
      <div className="container-wide px-4 md:px-6">
        ...
        <div className="mb-16">
          <div className="grid lg:grid-cols-3 gap-8 mb-12">
            ...
            return <div key={index} className="premium-card p-6 hover-lift">
                  {/* Featured Badge */}
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {project.tech.map((tech, i) => <span key={i} className="px-2 py-1 text-xs font-medium rounded-full bg-muted border border-border">
                        {tech}
                      </span>)}
                  </div>
                  ...
                  <div className="flex gap-3">
                    <a href={project.github} target="_blank" rel="noopener noreferrer" className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg border border-border hover:border-primary/30 transition-all duration-300 text-sm font-medium">
                      <Github className="w-4 h-4" />
                      <span>View Code</span>
                    </a>
                    
                    {project.live && <a href={project.live} target="_blank" rel="noopener noreferrer" className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-primary text-white hover:bg-primary/90 transition-all duration-300 text-sm font-medium">
        ...
        <div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            const IconComponent = project.icon;
            return <div key={index} className="soft-card p-6 hover-lift-subtle">
                  {/* Header */}
                  <div className="mb-4">
                  ...
                  <div className="flex flex-wrap gap-1.5 mb-4">
                    {project.tech.map((tech, i) => <span key={i} className="px-2 py-1 text-xs font-medium rounded-full bg-muted">
                        {tech}
                      </span>)}
                  </div>

                  {/* Action Button */}
                  <a href={project.github} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 w-full px-4 py-2 rounded-lg border border-border hover:border-primary/30 transition-all duration-300 text-sm font-medium">
                    <Github className="w-4 h-4" />
                    <span>View Code</span>
                  </a>
                </div>;
        ...
        <div className="text-center mt-16">
          <div className="soft-card p-8 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="https://github.com/saumyaprasad07" target="_blank" rel="noopener noreferrer" className="button-primary inline-flex items-center justify-center">
